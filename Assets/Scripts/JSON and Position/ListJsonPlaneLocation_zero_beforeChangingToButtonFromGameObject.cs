...
// Cou
public class ListJsonPlaneLocation_zero_beforeChangingToButtonFromGameObject : MonoBehaviour
{
    ...
    public void PlaneLocation()
    {
        ...
        Debug.Log("Entered response index " + responseIndex);
        ...
        //result = string.Join(", ", planesPreviousPosition[y]);
        //Debug.Log(" VECTOR3: " + string.Join(" ", planesPreviousPosition.Select(v => $"({v.x}, {v.y}, {v.z})")));
